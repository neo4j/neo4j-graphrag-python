...
class WeaviateNeo4jRetriever(ExternalRetriever):
    def __init__(
        ...
        self._id_property_external = id_property_external
        self._id_property_neo4j = id_property_neo4j
    ...
    def id_property_external(self):
        return self._id_property_external

    @property
    def id_property_neo4j(self):
        return self._id_property_neo4j
    ...
    def search(
        ...
        result_tuples = [
            [f"{o.properties[self._id_property_external]}", o.metadata.certainty or 0.0]
