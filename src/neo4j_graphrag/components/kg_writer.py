    ...
    Attributes:
        ...
        metadata: Optional dict. When status is SUCCESS, contains at least:
            ...
            - "files": list of file descriptors with file_path, etc. (ParquetWriter).
              ...
              vs UNIQUENESS constraints per :class:`~neo4j_graphrag.components.schema.GraphSchema`).
...
class ParquetWriter(KGWriter):
    ...
    .. code-block:: python
        ...
        from neo4j_graphrag.components.parquet_output import ParquetOutputDestination
        from neo4j_graphrag.experimental.pipeline import Pipeline
