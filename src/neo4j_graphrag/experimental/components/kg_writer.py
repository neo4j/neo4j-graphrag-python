...
class Neo4jWriter(KGWriter):
    ...
    def _upsert_nodes(
        ...
        - Lexical graph nodes (Chunk, Document): Always uses CREATE.
        - Entity nodes missing merge_property: Skipped with warning.
    ...
    async def run(
        ...
        try:
            ...
            stats["nodes_created"] = len(graph.nodes) - nodes_skipped
            stats["nodes_skipped_missing_merge_property"] = nodes_skipped
